...
# MEDIA
# ------------------------------------------------------------------------------
DEFAULT_FILE_STORAGE = "memo.utils.storages.MediaRootGoogleCloudStorage"
...
EMAIL_SUBJECT_PREFIX = env("DJANGO_EMAIL_SUBJECT_PREFIX", default="[BrainGain]")
...
ANYMAIL = {
    "MAILGUN_API_KEY": env(
        "MAILGUN_API_KEY", default="4e37273b34205bb0eafb6a6b203b21c4-28d78af2-5e57ea7e"
    ),
    "MAILGUN_SENDER_DOMAIN": env("MAILGUN_DOMAIN", default="mg.braingain.ai"),
